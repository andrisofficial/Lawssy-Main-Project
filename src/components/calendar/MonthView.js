  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{
        ...
        <Paper elevation={0} sx={{ 
          ...
          <Box sx={{ 
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              ...
              <Typography variant="subtitle1" sx={{ mx: 1, fontWeight: 500 }}>
        ...
        {/* Events Section at the bottom of the calendar */}
        <Paper elevation={0} sx={{ 
          p: 2, 
          mt: 1, 
          borderRadius: 2, 
          ...
          {events.filter(event => !event.showInAgenda).length === 0 ? (
            <Typography variant="body2" sx={{ color: 'text.secondary', textAlign: 'center', py: 2 }}>
              No tasks to display. Use "Add Task" to create tasks that will appear here.
            </Typography>
          ) : (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              {events
                .filter(event => !event.showInAgenda)
