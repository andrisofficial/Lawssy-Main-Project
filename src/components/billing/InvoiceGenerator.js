  ...
  return (
    <Box>
      ...
      <Dialog 
        ...
        onClose={() => !successMessage && setInvoiceDialogOpen(false)}
        maxWidth="md"
        fullWidth
      >
        <DialogTitle>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography variant="h6">
              {previewMode ? 'Invoice Preview' : 'Generate New Invoice'}
            </Typography>
            <Button 
              variant="outlined" 
              onClick={handleTogglePreview}
            >
              {previewMode ? 'Edit Details' : 'Preview Invoice'}
            </Button>
          </Box>
        </DialogTitle>
        <DialogContent>
          ...
          {previewMode ? (
            // Invoice Preview
            <Box sx={{ mt: 2, p: 3, border: '1px solid #eee' }}>
        ...
        <DialogActions>
          ...
          >
            {previewMode ? 'Generate Invoice' : 'Save & Preview'}
          </Button>
        </DialogActions>
      </Dialog>
    </Box>
